...
import ru.otus.otuskotlin.workout.mp.transport.models.ReadExerciseRequestAllOf
...
data class ReadExerciseRequest (
    ...
    @SerialName(value = "readExerciseId") val readExerciseId: kotlin.String? = null,
