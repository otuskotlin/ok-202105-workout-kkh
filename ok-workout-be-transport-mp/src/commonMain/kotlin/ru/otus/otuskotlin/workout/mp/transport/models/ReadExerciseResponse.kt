...
import ru.otus.otuskotlin.workout.mp.transport.models.ReadExerciseResponseAllOf
 ...
 */
@Serializable
data class ReadExerciseResponse (
    ...
    @SerialName(value = "result") val result: ReadExerciseResponse.Result? = null,
    @SerialName(value = "errors") val errors: kotlin.collections.List<RequestError>? = null,
    @SerialName(value = "readExercise") val readExercise: ResponseExercise? = null
) : BaseMessage {
