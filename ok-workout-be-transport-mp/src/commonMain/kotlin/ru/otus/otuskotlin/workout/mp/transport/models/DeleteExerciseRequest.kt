...
import ru.otus.otuskotlin.workout.mp.transport.models.DeleteExerciseRequestAllOf
...
data class DeleteExerciseRequest (
    ...
    @SerialName(value = "deleteExerciseId") val deleteExerciseId: kotlin.String? = null,
