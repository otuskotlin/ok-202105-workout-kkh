...
internal fun CorChainDsl<BeContext>.checkOperationWorker(title: String, targetOperation: ru.otus.otuskotlin.workout.backend.common.context.BeContext.MpOperations) =
    worker {
        this.title = title
